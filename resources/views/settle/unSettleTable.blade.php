                                ...
                                @else
                                                ...
                                                <table style="font-family: arial, sans-serif; border-collapse: collapse; width: 100%;">
                                                    <tr>
                                                        ...
                                                        <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;  width:250px;"  >
                                                            <span id="displayAccountType">{{ $merchantBankFirst?->bank?->account_type }}</span>
                                                        </td>
                                                        ...
                                                        <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; width:250px;"   >
                                                            <span id="displayAccountName">{{ $merchantBankFirst?->account_name }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th style="border: 1px solid #dddddd; text-align: left; padding: 8px; width:250px;"  >
                                                            <span id="displayBankName">{{ $merchantBankFirst?->bank_name }}</span>
                                                        </th>
                                                        ...
                                                        <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; width:250px;" >
                                                            <span id="displayAccountNumber">{{ $merchantBankFirst?->account_number }}</span>
                                                        </td>
                                                    </tr>
                                                </table>
                                    ...
                                    @else
                                        <div class="text-black">
                                            {{ trans('messages.Bank Account not found') }}! {{ trans('messages.Please add bank account') }} <a href="{{ route('Account: View Merchant Account') }}" class="text-blue text-decoration-underline">{{ trans('messages.here') }}</a> {{ trans('messages.before requesting settle') }}.
                                        </div>
                                    @endif
                                                ...
                                                <tbody>
                                                    @foreach ($paymentDetails as $item)
                                                        <tr>
                                                            ...
                                                            <td align="right">{{ number_format($item->paymentMaps->merchant_commission, 2) }}</td>
                                                            <td align="right">{{ number_format($item->amount - (($item->amount * $item->paymentMaps->merchant_commission) / 100), 2) }}</td>
                                                            <td align="right"><input name="payment" type="checkbox" id="{{ $item->id }}" value="{{ $item->amount }}" data-netAmount="{{ $item->amount - (($item->amount * $item->paymentMaps->merchant_commission) / 100) }}"></td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-btn delete-action">
                        <form id="autoSubmit">
                            ...
                            <input type="hidden"  name="account_id" id="formAccountId" value="{{ $merchantBankFirst?->id }}" />
                                ...
                                <table class="table table-borderless table-sm">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" id="modalBankName">{{ $merchantBankFirst?->bank_name }}</td>
                                        </tr>
                                        <tr>
                                            <td><span class="form-label">{{ __('messages.Account Name') }}</span></td>
                                            <td align="right" id="modalAccountName">{{ $merchantBankFirst?->account_name }}</td>
                                        </tr>
                                        <tr>
                                            <td><span class="form-label">{{ __('messages.Account Number') }}</span></td>
                                            <td align="right" id="modalAccountNumber">{{ $merchantBankFirst?->account_number }}</td>
                                        </tr>
                                    </tbody>
                                </table>
