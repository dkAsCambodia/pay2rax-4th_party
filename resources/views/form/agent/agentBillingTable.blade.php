        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="col-md-6 breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a
                            href="{{ route('Agent: View Agent') }}">{{ __('messages.Agent Management') }}</a></li>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('Settlement: Billing Agent Settlement') }}" method="POST"
                                id="form_billing_agent">
                                @csrf
                                    ...
                                    <div class="mb-3 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="agent_name"
                                                value="{{ $agent_billing->agent_name }}">
                                            <input type="hidden" name="agent_id" value="{{ $agent_billing->id }}">
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-4">
...
@section('script')
    <script>
        ...
        // edit agent
        $("#form_billing_agent").on('submit', function(e) {
            if ($(this).valid()) {
                e.preventDefault();
                $.ajax({
                    url: "{{ route('Settlement: Billing Agent Settlement') }}",
                    type: 'POST',
                    data: $('#form_billing_agent').serialize(),
