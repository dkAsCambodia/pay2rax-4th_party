        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="col-md-6 breadcrumb">
                    ...
                    <li class="breadcrumb-item"> {{ __('messages.Login Logs') }} </li>
                </ol>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('messages.Login Logs') }}</h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="loginDataTable" style="width: 100% !important">
                                    <thead>
                                        <tr>
                                            <th> {{ __('messages.Login Time') }}</th>
            ...
            $(function () {
                $('#loginDataTable').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'user_role', name: 'user.role_name'},
                        {data: 'ip_address'},
                        {data: 'user_agent'},
                    ],
                    language: {
